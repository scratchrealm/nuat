...
const BoxGrid: FunctionComponent<PropsWithChildren<Props>> = ({width, height, children}) => {
    ...
    const boxPositions = useMemo(() => {
        ...
        const numCols = Math.ceil(Math.sqrt(numBoxes * widthToHeightRatio / targetWidthToHeightRatio))
